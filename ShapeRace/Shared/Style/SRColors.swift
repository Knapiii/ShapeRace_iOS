...
public enum SRColor {
    ...
    public static var reversedLabel: UIColor {
        if #available(iOS 13, *) {
    ...
    public static var fadedPopUpViewBackground: UIColor {
        if #available(iOS 13, *) {
            return UIColor { (traits) -> UIColor in
                return traits.userInterfaceStyle == .dark ? SRColor.systemBackground : UIColor.black.withAlphaComponent(0.5)
            }
        }
        return UIColor.black.withAlphaComponent(0.5)
    }
    
    public static var cell: UIColor {
    ...
    public static var darkGrey: UIColor {
        if #available(iOS 13.0, *) {
            return UIColor { (traits) -> UIColor in
                return traits.userInterfaceStyle == .dark ? SRColor.systemGray5 : UIColor.init(hexColor: "#2C2C2E")
            }
        } else {
            return UIColor.init(hexColor: "#2C2C2E")
        }
    }
    ...
    public static var background: UIColor {
        if #available(iOS 13.0, *) {
            return UIColor { (traits) -> UIColor in
                return traits.userInterfaceStyle == .dark ? SRColor.systemGray6 : .white
            }
        } else {
            return .white
        }
    ...
    public static var navigationBarBackground: UIColor {
        if #available(iOS 13.0, *) {
            return UIColor { (traits) -> UIColor in
                return traits.userInterfaceStyle == .dark ? SRColor.systemGray6 : UIColor(hexColor: "#F9F9F9")
            }
        } else {
            return UIColor(hexColor: "#F9F9F9")
        }
    }
    ...
    public static var borderColor: UIColor {
        if #available(iOS 13.0, *) {
            return UIColor { (traits) -> UIColor in
                return traits.userInterfaceStyle == .dark ? SRColor.tertiarySystemBackground : SRColor.secondarySystemBackground
            }
        } else {
            return SRColor.secondarySystemBackground
        }
    }
    
    public static var reverseBorderColor: UIColor {
        if #available(iOS 13.0, *) {
            return UIColor { (traits) -> UIColor in
                return traits.userInterfaceStyle == .light ? SRColor.tertiarySystemBackground : SRColor.secondarySystemBackground
            }
        } else {
            return SRColor.secondarySystemBackground
        }
