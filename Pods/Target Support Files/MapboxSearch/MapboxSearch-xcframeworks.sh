...
install_xcframework "${PODS_ROOT}/MapboxSearch/MapboxSearch.xcframework" "MapboxSearch" "framework" "ios-x86_64-simulator/MapboxSearch.framework" "ios-arm64/MapboxSearch.framework"
